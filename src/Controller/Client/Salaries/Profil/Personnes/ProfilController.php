...
namespace App\Controller\Client\Salaries\Profil\Personnes;
...
/**
 * @Route("/client/salaries/{id}/profil/personnes")
 */
class ProfilController extends AbstractController
{
     ...
     * @Route("/", name="cli_salaries_profil_personnes")
     */
    public function voir(Request $request, $id, TranslatorInterface $translator)
    {
        ...
        $personness = $this->getDoctrine()->getRepository(Profil::class)->findByUser($salarie);
        ...
        if ($profilForm->isSubmitted() && $profilForm->isValid()) {
            ...
            return $this->redirectToRoute('cli_salaries_profil_personnes', ['id' => $id]);
        }
