...
namespace App\Controller\Client\Salaries\Profil\Coordonnees;
...
/**
 * @Route("/client/salaries/{id}/profil/coordonnees")
 */
class ProfilController extends AbstractController
{
     ...
     * @Route("/", name="cli_salaries_profil_coordonnees")
     */
    public function voir(Request $request, $id, TranslatorInterface $translator)
    {
        ...
        $profilSalaries = $salarie->getProfil()->getCoordonnees();
        if ($profilSalaries == null) {
            $profilSalaries = new Profil();
            $user->getProfil()->setCoordonnees($profilSalaries);
        }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('cli_salaries_profil_coordonnees', ['id' => $id]);
        }
     ...
     *
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|Response
     * @Route("/modifier", name="cli_salaries_profil_modifier_coordonnees")
     */
    public function modifier(Request $request, $id, TranslatorInterface $translator)
    {
        ...
        if ($profilSalaries == null) {
            $profilSalaries = new Profil();
            $salarie->getProfil()->setCoordonnees($profilSalaries);
        }
        $idSalarie = $salarie->getId();
