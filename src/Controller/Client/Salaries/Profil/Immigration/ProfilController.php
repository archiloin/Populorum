...
namespace App\Controller\Client\Salaries\Profil\Immigration;
...
/**
 * @Route("/client/salaries/{id}/profil/immigration")
 */
class ProfilController extends AbstractController
{
     ...
     * @Route("/", name="cli_salaries_profil_immigration")
     */
    public function voir(Request $request, $id, TranslatorInterface $translator)
    {
        ...
        $immigrations = $this->getDoctrine()->getRepository(Profil::class)->findByUser($salarie);
        ...
        if ($profilForm->isSubmitted() && $profilForm->isValid()) {
            ...
            return $this->redirectToRoute('cli_salaries_profil_immigration', ['id' => $id]);
        }
