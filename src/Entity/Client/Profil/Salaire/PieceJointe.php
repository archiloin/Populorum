<?php
namespace App\Entity\Client\Profil\Salaire;
...
/**
 * PieceJointe
 * @ORM\Table(name="cli_profil_salaire_piece_jointe")
 * @ORM\Entity(repositoryClass="App\Repository\Client\Profil\Salaire\PieceJointeRepository")
 * @Vich\Uploadable
 */
class PieceJointe
{
