<?php
namespace App\Entity\Client\Profil\Reporter;
...
/**
 * PieceJointe
 * @ORM\Table(name="cli_profil_reporter_piece_jointe")
 * @ORM\Entity(repositoryClass="App\Repository\Client\Profil\Reporter\PieceJointeRepository")
 * @Vich\Uploadable
 */
class PieceJointe
{
