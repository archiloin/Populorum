...
/**
 * PieceJointe
 * @ORM\Table(name="cli_profil_info_entreprise_piece_jointe")
 * @ORM\Entity(repositoryClass="App\Repository\Client\Profil\InformationsEntreprise\PieceJointeRepository")
 * @Vich\Uploadable
 */
class PieceJointe
{
